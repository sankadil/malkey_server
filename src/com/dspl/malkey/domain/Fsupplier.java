...
@NamedNativeQueries({
	@NamedNativeQuery(name="Fsupplier.EmailID", query="SELECT f.supcode,f.supname,f.supemail,f.typ,f.recordid FROM Fsupplier2 f WHERE f.supemail!=''", resultSetMapping="Fsupplier.EmailID.Rsm")
})
