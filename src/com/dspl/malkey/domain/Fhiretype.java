...
/**
 * The persistent class for the fhiretype database table.
 * 
 */
@Entity
@Table(name="fhiretype")
@NamedQueries({@NamedQuery(name="FhiretypeListAll", query="SELECT f FROM Fhiretype f")})

public class Fhiretype implements Serializable {
