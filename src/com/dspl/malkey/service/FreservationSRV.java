...
public interface FreservationSRV {
	int count();
//	Boolean create(Freservation freservation);
	Freservation findByID(String resno);
	List<Freservation> List(int startIndex, int numItems);
	List<Freservation> ListAll();
	Boolean removeByID(String resno);

/*	Boolean update(Freservation freservation, List<Fresvehicle> lstfresvehicle,
	...
	String create(Freservation freservation, Freshed freshed,
	...
	String changeStatus(Freservation freservation, Freshed freshed,
			List<Fresvehicle> lstfresvehicle, List<Fresaccs> lstfresaccs,
			List<Fresdriver> lstfresdriver, List<Fresothsrv> lstfresothsrv,
			Fresvehiclerate fresvehiclerate, List<Fresaccrate> lstfresaccrate,
			Fresdriverrate fresdriverrate,
	...
	List<FreservationView> loadCAH2(String debcode);
