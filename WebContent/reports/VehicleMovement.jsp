...
<%@page import="com.dspl.malkey.service.FgatepassSRV"%>
...
<%@page import="com.dspl.malkey.domain.Fgatepass"%>
...
<%
	...
	Object reportSource =null; //session.getAttribute("Report7");
	    ...
	    FgatepassSRV srv = (FgatepassSRV) wac.getBean("fgatepassSRV");
		/*Following code retrive data from service*/
		//Fgatepass fgatepass= srv.findByPassNo(request.getParameter("pn").toString());
		List<Fgatepass> fgatepasses= srv.getGatePassList(request.getParameter("df").toString(),request.getParameter("dt").toString(),request.getParameter("st").toString());
