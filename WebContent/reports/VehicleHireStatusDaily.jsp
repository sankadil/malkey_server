...
<title>Daily Agreement Sheet</title>
</head>
<body>
...
<%
	...
	String reportName = "reports/VehicleHireStatusDaily.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
		...
		List<Freservationdiaryrpt> fresdiaryrecs= srv.getVehicleHireStatusDaily(request.getParameter("df").toString(),request.getParameter("dt").toString(),request.getParameter("ht").toString(),request.getParameter("hs").toString(),request.getParameter("rt").toString());
