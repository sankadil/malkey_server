...
<%
	...
	String reportName = "reports/ReservationDiaryWithHireStatus.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
		...
		List<Freservationdiaryrpt> fresdiaryrecs= srv.getResDiaryData(request.getParameter("df").toString(),request.getParameter("dt").toString(),"","'"+request.getParameter("hs").toString()+"'"/*"'CONFIRMED','PREPARED'"*/);
		...
		ParameterFieldController paramController;
   		...
   		paramController.setCurrentValue("", "status", request.getParameter("hs").toString());
