...
<%@page import="com.dspl.malkey.service.FdebtorSRV"%>
...
<%@page import="com.dspl.malkey.domain.Fdebtor"%>
...
<%
	...
	String reportName = "reports/CustomerList.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
	    ...
	    FdebtorSRV srv = (FdebtorSRV) wac.getBean("fdebtorSRV");
		...
		{
				isLongTerm=request.getParameter("ct").equalsIgnoreCase("LONGTERM");
				if(!isLongTerm){
				param=request.getParameter("ct").toString();
				}
		}
		System.out.print("param:"+param);
		System.out.print("isLongTerm:"+isLongTerm);
		List<Fdebtor> list= srv.getDebtorList(param,isLongTerm);
		/*Following code set data to report*/
		//dbc.setDataSource(lst, CommMF.class, "Fmasterlist","Fmasterlist");
			
		dbc.setDataSource(list, Fdebtor.class, "Fdebtor", "Fdebtor");
