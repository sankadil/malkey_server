...
<%
	...
	String reportName = "reports/RegistryOfRentedVehicles.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
		...
		List<Freservationdiaryrpt> fresdiaryrecs= srv.getRentedVehicleDet(request.getParameter("df").toString(),request.getParameter("dt").toString());
