...
<%
	...
	String reportName = "reports/VehicleHireStatusCO.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
		...
		List<Freservationdiaryrpt> fresdiaryrecs= srv.getVehicleHireStatusCO(request.getParameter("df").toString(),request.getParameter("dt").toString(),request.getParameter("ht").toString(),request.getParameter("hs").toString(),request.getParameter("rt").toString());
