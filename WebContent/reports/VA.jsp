...
<%@page import="com.dspl.malkey.view.FreservationView"%>
<%@page import="com.dspl.malkey.view.VehicleAvailabilityView"%><html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Hire Chain Data</title>
</head>
<body>
<%------------Beginning of 'Open and View Report' snippet----------------%>
<%
	
//String reportName = "reports/HCD.rpt";
...
//		DatabaseController dbc = reportClientDocument.getDatabaseController();
	    ...
	    List<VehicleAvailabilityView> list= srv.loadVehicleAvailability(from,to);
	    out.print("download report from http://server:8400/malkey_server/resources/");
	    /*		for(int i=0;i<list.size();i++)
		{
			...
			System.out.println("AvailabilityCalander "+ vehicleAvailabilityView.getAvailabilityCalander());
