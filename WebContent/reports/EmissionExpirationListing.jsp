...
<%
	...
	String reportName = "reports/EmissionExpirationListing.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
		...
		List<Fexpirationlistingrpt> list= srv.getExpirationList(request.getParameter("df").toString(),request.getParameter("dt").toString(),"E");
