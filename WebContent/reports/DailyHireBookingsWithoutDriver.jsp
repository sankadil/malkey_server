...
<%
	...
	String reportName = "reports/DailyHireBookingsWithoutDriver.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
		...
		List<Freservationdiaryrpt> fresdiaryrecs= srv.getResDiaryData(request.getParameter("df").toString(),request.getParameter("dt").toString(),"'SD'","'CONFIRMED','PREPARED'");
