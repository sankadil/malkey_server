...
<%@page import="com.dspl.malkey.service.FmasterlistSRV"%>

<%@page import="com.dspl.malkey.domain.CommMF"%>
...
<%
	...
	String reportName = "reports/MasterList.rpt";
	Object reportSource =null; //session.getAttribute("Report7");
	    ...
	    try
	    {
	    FmasterlistSRV srv = (FmasterlistSRV) wac.getBean("fmasterlistSRV");
		/*Following code retrive data from service*/
		List<CommMF> lst= srv.ListMF(request.getParameter("tn").toString(),request.getParameter("kf").toString());
		/*Following code set data to report*/
		//dbc.setDataSource(lst, CommMF.class, "Fmasterlist","Fmasterlist");
		dbc.setDataSource(lst, CommMF.class, "CommMF", "CommMF");
